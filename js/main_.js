...
const URL = 'http://www.theaudiodb.com/api/v1/json/';
...
//`https://www.theaudiodb.com/api/v1/json/1/artist.php?i={wordToSearch}`
 

function searchWeather(wordToSearch){
  console.log('Palabra', wordToSearch);

 // const fetchPromise = fetch(`https://theaudiodb.com/api/v1/json/{APIKEY}/discography.php?s={wordToSearch}`);
const fetchPromise = fetch(`https://theaudiodb.com/api/v1/json/{APIKEY}/discography.php?s=coldplay`);
